<ul class="nav nav-pills">
    ...
    <li class="dropdown">
        <a href="#" data-toggle="dropdown" class="dropdown-toggle">ตั้งค่า <b class="caret"></b></a>
        <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li><a href="index.php?page=alb">อัลบัมรูป</a></li>
            <li><a href="index.php?page=alb-file">อัลบัมรูป - item</a></li>
            <li class="divider"></li>
            <li><a href="index.php?page=promote">โปรโมชั่น</a></li>
